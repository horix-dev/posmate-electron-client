...
import { Package, Loader2, Layers, ArrowLeft, Save } from 'lucide-react'
...
export default function CreateProductPage() {
  ...
  // Fetch data
  const { categories, brands, units, createProduct } = useProducts(DEFAULT_FILTERS)
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Default alert level if not set per variant.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
